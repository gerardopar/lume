...
export const MovieNowPlayingCardList: React.FC<{
  ...
  const { data, isLoading, fetchNextPage, hasNextPage, isFetchingNextPage } =
    trpc.movies.getNowPlayingMovies.useInfiniteQuery(
      {},
      {
  ...
  if (isLoading) {
    return (
      <div className={`w-full relative ${className}`}>
        <h2 className="text-xl font-bold font-inter mb-2 ml-2">Now Playing</h2>
...
export default MovieNowPlayingCardList;
