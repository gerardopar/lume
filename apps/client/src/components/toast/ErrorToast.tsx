...
export const ErrorToast: React.FC<{ message: string }> = ({ message }) => {
  ...
  return (
    <div className="border border-red-500 text-white bg-red-300 w-full p-4 rounded-[10px] shadow-lg flex items-center gap-2">
      <div className="p-2 bg-red-500 rounded-full">
        <XIcon className="inline text-white" />
      </div>
      <div className="flex flex-col items-start ml-1 text-lume-primary-dark mr-8">
        <p className="font-inter font-bold text-base">Something went wrong</p>
